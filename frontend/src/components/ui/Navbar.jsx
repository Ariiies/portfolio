  ...
  return (
    <nav className="navbar">
      ...
      <ul className="nav-list desktop-nav">
        ...
        <li>
          <a 
            href="https://www.linkedin.com/in/luis-aries-meza-castillo-a53727263" 
            target="_blank" 
            rel="noopener noreferrer"
            className="nav-social"
            title="LinkedIn"
        ...
        <li>
          <button 
            ...
            className="nav-action contact-btn"
            title="Contactar"
          >
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-menu-content">
          ...
          <div className="mobile-section">
            <h3 className="mobile-section-title">Sígueme</h3>
          ...
          <div className="mobile-section">
            ...
            <div className="mobile-actions">
              ...
              <button 
                ...
                className="mobile-action-item contact-item"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z"/>
                </svg>
